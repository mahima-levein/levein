                  ...
                  <div className="grid grid-cols-2 md:flex md:flex-wrap items-center gap-x-4 md:gap-x-6 gap-y-3 text-[12px] lg:text-[16px] text-[#326262] pb-1">
                    ...
                    <span className="flex items-center gap-2 leading-none">
                      <svg className="relative -top-px" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M8.67 14H4C2.9 14 2 14.9 2 16V22H8.67V14Z" stroke="#326262" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M13.3302 10H10.6602C9.56016 10 8.66016 10.9 8.66016 12V22H15.3302V12C15.3302 10.9 14.4402 10 13.3302 10Z" stroke="#326262" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M20.0001 17H15.3301V22H22.0001V19C22.0001 17.9 21.1001 17 20.0001 17Z" stroke="#326262" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M12.5202 2.0708L13.0502 3.1308C13.1202 3.2808 13.3102 3.42079 13.4702 3.44079L14.4302 3.6008C15.0402 3.7008 15.1902 4.15078 14.7502 4.58078L14.0002 5.33078C13.8702 5.46078 13.8002 5.70079 13.8402 5.87079L14.0502 6.7908C14.2202 7.5208 13.8302 7.80081 13.1902 7.42081L12.2902 6.89081C12.1302 6.79081 11.8602 6.79081 11.7002 6.89081L10.8002 7.42081C10.1602 7.80081 9.77023 7.5208 9.94023 6.7908L10.1502 5.87079C10.1902 5.70079 10.1202 5.45078 9.99023 5.33078L9.25023 4.59079C8.81023 4.15079 8.95023 3.71078 9.57023 3.61078L10.5302 3.4508C10.6902 3.4208 10.8802 3.28081 10.9502 3.14081L11.4802 2.08078C11.7702 1.50078 12.2302 1.5008 12.5202 2.0708Z" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      {job.job_level.join(' / ')}
                    </span>
                    ...
                    <span className="flex items-center gap-2 leading-none">
                      <svg className="relative -top-px" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M13.6827 6.62266C15.716 8.65599 15.716 11.956 13.6827 13.9893C11.6494 16.0226 8.34935 16.0226 6.31602 13.9893C4.28268 11.956 4.28268 8.65599 6.31602 6.62266C8.34935 4.58932 11.6494 4.58932 13.6827 6.62266Z" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M6.87451 18.0318C5.20784 17.3651 3.7495 16.1568 2.78284 14.4818C1.83284 12.8401 1.51617 11.0151 1.74117 9.27344" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M4.875 3.73151C6.29167 2.62317 8.06666 1.96484 10 1.96484C11.8917 1.96484 13.6333 2.6065 15.0333 3.67317" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M13.125 18.0318C14.7917 17.3651 16.25 16.1568 17.2167 14.4818C18.1667 12.8401 18.4833 11.0151 18.2583 9.27344" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    ...
                    <span className="hidden md:flex items-center gap-2 leading-none">
                      <svg className="relative -top-px" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M18.3337 10.0013C18.3337 14.6013 14.6003 18.3346 10.0003 18.3346C5.40033 18.3346 1.66699 14.6013 1.66699 10.0013C1.66699 5.4013 5.40033 1.66797 10.0003 1.66797C14.6003 1.66797 18.3337 5.4013 18.3337 10.0013Z" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M13.0914 12.6495L10.5081 11.1078C10.0581 10.8411 9.69141 10.1995 9.69141 9.67448V6.25781" stroke="#326262" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
