  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white font-sans">
      ...
      <div className="mt-6 border-t border-gray-200 flex flex-col items-center text-center">
        ...
        <button className="bg-[#EAF2EB] hover:bg-[#dbe7dd] text-[#111715] font-medium px-6 py-3 rounded-full flex items-center gap-2 transition-colors duration-300 text-[18px]">
          <BellIcon />
          Notify me
        </button>
      </div>
